    ...
    Router = (function () {
                ...
                if(router){
                    ...
                    if(module){
                        ...
                        _loadModule(router.htmlPath, function (dom) {
                            ...
                            require([router.modulePath], function (vm) {
                                VM = new vm[router.moduleName]();
                                VM.init();
                                _addModule({moduleName:router.moduleName, moduleObject:VM});              
                            });
                        });
                    }                    
                }               
        ...
        */
        ...
        _constr.prototype = {
            ...
            /**
             * 获取模块
             * 根据模块名称从内存中查找对应模块并返回此模块
             * @param  {object} param [模块名称]
             * @return {object} [实例化的模块对象]
             */
            getModule: function(moduleName){
                var moduleInfo = _findModule(moduleName);
                return moduleInfo.moduleObject;
            }
        };
